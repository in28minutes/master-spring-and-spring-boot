...
public EntityModel<@NonNull User> retrieveUser(@PathVariable int id) {
	...
	EntityModel<@NonNull User> entityModel = EntityModel.of(user);
...
- Reference Link : https://spring.io/blog/2025/10/07/introducing-jackson-3-support-in-spring?utm_source=chatgpt.com#goodbye-mappingjacksonvalue
```java
public class Views {
...
### /src/main/java/com/in28minutes/rest/webservices/restfulwebservices/jpa/UserRepository.java Modified
