...
```
- Spring Boot 4 has incorporated the `version` attribute within the request mapping annotation. For further information, kindly refer to https://spring.io/blog/2025/09/16/api-versioning-in-spring
- As we are utilizing the same method names found in the VersioningPersonController, please provide comments for this class and focus on the VersioningPersonControllerV2.

### /src/main/java/com/in28minutes/rest/webservices/restfulwebservices/versioning/WebConfig.java New
